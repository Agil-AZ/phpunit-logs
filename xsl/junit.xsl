    ...
    <html>
      ...
      <body>
        ...
        <xsl:for-each select="testsuites/testsuite">
          <h1>&#160;&#160;&#160;</h1>
          <h4><xsl:value-of select="@tests"/>&#160;</h4><h3>tests&#160;whith&#160;</h3>
          <h4><xsl:value-of select="@failures"/>&#160;</h4><h3>failures&#160;and&#160;</h3>
          <h4><xsl:value-of select="@errors"/>&#160;</h4><h3>errors&#160;in&#160;</h3>
          <h4><xsl:value-of select="@time"/></h4><h3>s</h3>
          <xsl:for-each select="testsuite">
            ...
            <tr class="{$alltests-class}">
              <td>
                ...
                <h4><xsl:value-of select="@tests"/>&#160;</h4><p>tests&#160;whith&#160;</p>
                <h4><xsl:value-of select="@failures"/>&#160;</h4><p>failures&#160;and&#160;</p>
                <h4><xsl:value-of select="@errors"/>&#160;</h4><p>errors&#160;in&#160;</p>
                <h4><xsl:value-of select="@time"/></h4><p>s</p>
              </td>
            </tr>
            <tr class="{$alltests-class}">
              <td>
                      ...
                      <xsl:for-each select="testcase">
                        <xsl:variable name="tests-class">
                          <xsl:choose>
                            ...
                            <xsl:otherwise>nofail</xsl:otherwise>
                          </xsl:choose>
                        </xsl:variable>
